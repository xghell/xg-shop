<template>
	<view class="uni-searchbar">
		<view :style="{borderTopLeftRadius:radius+'px',borderTopRightRadius:radius+'px',borderBottomRightRadius:radius+'px',borderBottomLeftRadius:radius+'px',backgroundColor: bgColor}" class="uni-searchbar__box" @click="searchClick">
			<!-- #ifdef MP-ALIPAY -->
